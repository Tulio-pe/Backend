package com.acme.tallerazo.iam.infrastructure.authorization.sfs.configuration;

import com.acme.tallerazo.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.acme.tallerazo.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
        ...
        http.csrf(csrfConfigurer -> csrfConfigurer.disable())
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        .requestMatchers(
                                ...
                                "/api/v1/services/**",      // <-- acceso público
                                "/api/v1/regions/**",       // <-- acceso público
                                "/api/v1/districts/**",     // <-- acceso público
                                "/api/v1/provinces/**",     // <-- acceso público
                                "/v3/api-docs/**",
                                "/swagger-ui.html",
                                "/swagger-ui/**",
                                "/swagger-resources/**",
